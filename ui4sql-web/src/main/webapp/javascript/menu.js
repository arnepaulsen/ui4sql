...
// Modified Arne Paulsen TAG V1.0 - allow the menu below top of page.  Use 'mytop' to define. Adjust logic to hide sub-menu using new myTop length 
...
function Menu()
{
	...
	HTMLstr += "\n";
	// position at top.. not browser check
	HTMLstr += "<div id='MainTable' style='position:absolute;top:" + myTop + ";left:0;'>\n";
...
function updateIt(e)
{
	if (ie&&!opr6)
	{
		...
		else if (y > rightY+myTop) hideAll();
	}
	if (n||ns6)
	{
		var x = e.pageX;
